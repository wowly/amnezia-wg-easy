...
iptables -A INPUT -p tcp -i wg0 --dport 51821 -j DROP;
...
iptables -D INPUT -p tcp -i wg0 --dport 51821 -j DROP;
...
const getRandomSignature = () => `<r ${getRandomInt(32, 1000)}>`;
...
module.exports.I1 = process.env.I1 || getRandomSignature();
module.exports.I2 = process.env.I2 || getRandomSignature();
module.exports.I3 = process.env.I3 || getRandomSignature();
module.exports.I4 = process.env.I4 || getRandomSignature();
module.exports.I5 = process.env.I5 || getRandomSignature();
